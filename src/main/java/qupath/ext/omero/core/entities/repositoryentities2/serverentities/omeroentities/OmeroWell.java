...
public record OmeroWell(
        ...
        @SerializedName(value = "Column") int column,
        @SerializedName(value = "Row") int row,
        @SerializedName(value = "omero:details:") OmeroDetails omeroDetails
) {
    private static final String TYPE = "http://www.openmicroscopy.org/Schemas/OME/2016-06#Well";
