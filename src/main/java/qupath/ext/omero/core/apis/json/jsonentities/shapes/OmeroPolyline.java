...
/**
 * An OMERO polyline as described by the <a href="http://www.openmicroscopy.org/Schemas/OME/2016-06#Polyline">OME specifications</a>.
 * <p>
 ...
 * @param points a text containing the points of this polyline. Required
...
public record OmeroPolyline(
    ...
    public OmeroPolyline {
        ...
        if (!TYPE.equals(type)) {
            logger.warn(
                    "The provided type {} does not correspond to the expected type {}. The created object might not represent a polyline",
                    type,
                    TYPE
            );
        }
