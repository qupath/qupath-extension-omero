...
public record OmeroLine(
    ...
    public OmeroLine {
        ...
        Objects.requireNonNull(x1, "X1 not provided");
        Objects.requireNonNull(y1, "Y1 not provided");
        Objects.requireNonNull(x2, "X2 not provided");
        Objects.requireNonNull(y2, "Y2 not provided");
