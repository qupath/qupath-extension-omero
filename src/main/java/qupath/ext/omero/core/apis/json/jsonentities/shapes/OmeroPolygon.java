...
/**
 * An OMERO polygon as described by the <a href="http://www.openmicroscopy.org/Schemas/OME/2016-06#Polygon">OME specifications</a>.
 * <p>
 ...
 * @param points a text containing the points of this polygon. Required
 * @param omeroDetails details about this shape. Optional
 */
public record OmeroPolygon(
    ...
    public static final String TYPE = "http://www.openmicroscopy.org/Schemas/OME/2016-06#Polygon";
    private static final Logger logger = LoggerFactory.getLogger(OmeroPolygon.class);
    ...
    public OmeroPolygon {
        ...
        if (!TYPE.equals(type)) {
            logger.warn(
                    "The provided type {} does not correspond to the expected type {}. The created object might not represent a polygon",
                    type,
                    TYPE
            );
        }
