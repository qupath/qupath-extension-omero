...
/**
 * An OMERO ellipse as described by the <a href="http://www.openmicroscopy.org/Schemas/OME/2016-06#Ellipse">OME specifications</a>.
 * <p>
 ...
 * @param x the X coordinate of the center of the ellipse. Required
 * @param y the Y coordinate of the center of the ellipse. Required
 * @param radiusX the radius of the ellipse projected to the X axis. Required
 * @param radiusY the radius of the ellipse projected to the Y axis. Required
...
public record OmeroEllipse(
    ...
    public OmeroEllipse {
        ...
        Objects.requireNonNull(radiusX, "RadiusX not provided");
        Objects.requireNonNull(radiusY, "RadiusY not provided");
