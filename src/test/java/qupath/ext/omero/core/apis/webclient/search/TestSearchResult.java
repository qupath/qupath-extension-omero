...
public class TestSearchResult {
    ...
    void Check_Results_Types() {
        List<EntityType> expectedTypes = List.of(EntityType.IMAGE, EntityType.IMAGE, EntityType.IMAGE);
        List<SearchResult> searchResults = createSearchResults();

        List<EntityType> resultsTypes = searchResults.stream()
