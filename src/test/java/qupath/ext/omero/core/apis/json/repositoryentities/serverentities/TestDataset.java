...
public class TestDataset extends OmeroServer {
    ...
    abstract static class GenericUser {
        ...
        void Check_Child_Count() {
            int expectedChildCount = OmeroServer.getDatasetChildCount(userType);

            int childCount = dataset.getChildCount();
        ...
        void Check_Description() {
            String expectedDescription = OmeroServer.getDatasetDescription();

            String description = dataset.getDescription().orElse(null);
